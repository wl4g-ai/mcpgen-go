...
EOEX
  ...
  ./mcpclient.sh call AddAutoPolicyWaiver '{"ownerId": "ownerId_value", "ownerType": "application", "body": {"ownerId": "ownerId_value", "ownerType": "ownerType_value", "autoPolicyWaiverId": "autoPolicyWaiverId_value", "pathForward": false, "scopesOperatorAny": false, "threatLevel": 0, "createTime": "2025-01-01", "reachability": false, "publicId": "publicId_value", "ownerName": "ownerName_value", "creatorName": "creatorName_value", "creatorId": "creatorId_value"}}'
EOEX
  cat <<'EOEX'
...
EOEX
  ...
  ./mcpclient.sh call AddSourceControl '{"internalOwnerId": "internalOwnerId_value", "ownerType": "application", "body": {"githubAppId": "githubAppId_value", "innerSourceAutomatedUpdatesEnabled": false, "statusChecksEnabled": false, "pullRequestCommentingEnabled": false, "baseBranch": "baseBranch_value", "manualPullRequestsEnabled": false, "sshEnabled": false, "repositoryUrl": "repositoryUrl_value", "remediationPullRequestsEnabled": false, "ownerId": "ownerId_value", "enableStatusChecks": false, "token": "token_value", "closePrAfterDays": 0, "closePrOnFailedChecksEnabled": false, "username": "username_value", "enablePullRequests": false, "provider": "provider_value", "nonGoldenPullRequestsEnabled": false, "sourceControlEvaluationsEnabled": false, "sourceControlScanTarget": "sourceControlScanTarget_value", "authenticationType": "authenticationType_value", "id": "id_value", "commitStatusEnabled": false, "closePrAfterDaysOpenEnabled": false}}'
EOEX
  cat <<'EOEX'
  # AddTag (POST)
